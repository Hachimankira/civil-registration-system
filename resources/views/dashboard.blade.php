            ...
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                    ...
                    <div class="px-4 py-8">
                        ...
                        <x-feature-right heading="Death Registration" description="Another featurette? Of course. More placeholder content here to give you an idea of how this layout would work with some actual real-world content in place." imgSrc="/images/logo.png" link="/birth/create"/>            
                        ...
                        <x-features heading="Nation ID card Registration" description="Another featurette? Of course. More placeholder content here to give you an idea of how this layout would work with some actual real-world content in place." imgSrc="/images/logo.png" link="/birth/create"/>
